...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Web Builds.data';
    var REMOTE_PACKAGE_BASE = 'Web Builds.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 4611949;
      var PACKAGE_UUID = '744a357c-f9d6-4889-9fad-8f9ea13f9b43';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 995794, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(995794, 995815, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(995815, 3087631, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(3087631, 4584323, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(4584323, 4611949, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Web Builds.data');

    };
    Module['addRunDependency']('datafile_Web Builds.data');
