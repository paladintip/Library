...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Platformer v0.8.46.data';
    var REMOTE_PACKAGE_BASE = 'Platformer v0.8.46.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 4128007;
      var PACKAGE_UUID = '0b5da4e3-6e28-4c18-8de7-5466264c3dd0';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 514332, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(514332, 514353, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(514353, 2603689, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2603689, 4100381, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(4100381, 4128007, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Platformer v0.8.46.data');

    };
    Module['addRunDependency']('datafile_Platformer v0.8.46.data');
